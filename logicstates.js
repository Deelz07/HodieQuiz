...
let Q5 = new Question("Q2:What is the term for grouping information into meaningful units to enhance memory capacity?",
  ["A) Categorising","B) Chunking","C) Mapping","D) Clustering",],"B) Chunking",{correct: "Correct!", incorrect: "Incorrect!"})
...
function submitAnswer(event) {
  ...
  if (selectedOption) {
    ...
    let ptag = newsubmit.querySelector('p');
    ptag.innerHTML = "Next";
...
function nextQuestion() {
  if (currentindex < questions.length) {
    ...
    let newsubmit = document.getElementById('submitButton');
    let ptag = newsubmit.querySelector('p');
    ptag.innerHTML = "Submit";
